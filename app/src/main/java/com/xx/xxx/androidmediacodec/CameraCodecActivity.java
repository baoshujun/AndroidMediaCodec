...
import com.xx.xxx.androidmediacodec.utils.AvcUtils;
import com.xx.xxx.androidmediacodec.utils.Decoder;
import com.xx.xxx.androidmediacodec.utils.Encoder;
...
public class CameraCodecActivity extends AppCompatActivity implements View.OnClickListener, Camera.PreviewCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_camera_codec);
        surfaceViewEncode = findViewById(R.id.surfaceViewEncode);
        surfaceViewDecode = findViewById(R.id.surfaceViewDecode);
